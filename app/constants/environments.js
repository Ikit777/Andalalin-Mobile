...
const environments = {
  DEVELOPMENT: {
    ENDPOINTS: {
      ...
      TAMBAH_PERSYARATAN_RAMBULALIN: url + "/api/v1/master/tambahpersyaratanrambulalin",
      HAPUS_PERSYARATAN_RAMBULALIN: url + "/api/v1/master/hapuspersyaratanrambulalin",
      EDIT_PERSYARATAN_RAMBULALIN: url + "/api/v1/master/editpersyaratanrambulalin",
    },
  },
  STAGING: {},
  PRODUCTION: {},
