...
const environments = {
  DEVELOPMENT: {
    ENDPOINTS: {
      ...
      ANDALALIN_CHECK_ADMINISTRASI: url + "/v1/permohonan/persyaratan/andalalin/pemeriksaan",
      ANDALALIN_CHECK_ADMINISTRASI_PERLALIN: url + "/v1/permohonan/persyaratan/perlalin/pemeriksaan",
      ANDALALIN_UPLOAD_DOKUMEN: url + "/v1/permohonan/upload/dokumen",
      ANDALALIN_UPDATE_PERSYARATAN: url + "/v1/permohonan/berkas/update",
      ANDALALIN_PEMBUATAN_SURAT_PERNYATAAN: url + "/v1/permohonan/pembuatan/pernyataan",
      ANDALALIN_PEMBUATAN_SURAT_KEPUTUSAN: url + "/v1/permohonan/pembuatan/keputusan",
      ANDALALIN_PEMBUATAN_PENYUSUN_DOKUMEN: url + "/v1/permohonan/pembuatan/penyusun",
      ...
      TAMBAH_PERSYARATAN_ANDALALIN: url + "/v1/master/tambah/persyaratan/andalalin",
      HAPUS_PERSYARATAN_ANDALALIN: url + "/v1/master/hapus/persyaratan/andalalin",
      EDIT_PERSYARATAN_ANDALALIN: url + "/v1/master/edit/persyaratan/andalalin",

      TAMBAH_PERSYARATAN_PERLALIN: url + "/v1/master/tambah/persyaratan/perlalin",
